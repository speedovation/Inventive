...
$.fn.extend({
...
}, "use strict", instanceId = 0, defaults = {
  delay: 0,
  duration: 0,
  easing: "ease-in-out",
  startOn: 0,
...
}, Herotabs.prototype._transitionProps.css === undefined ? Herotabs.prototype.showTab = function(tabToShow) {
  ...
  this._currentTab = tabToShow;
  return this;
} : void 0, $.fn.herotabs = function(options) {
...
}, $.fn.herotabs.defaults = defaults, $.fn.herotabs.Herotabs = Herotabs);
